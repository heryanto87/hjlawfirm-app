    ...
    <>
      ...
      <div className='grid grid-flow-row grid-cols-2 gap-10'>
        <div className='row-span-1 flex flex-col gap-6'>
          ...
          <div className='text-primary font-loravariable text-lg flex flex-col gap-4'>
        ...
        <div className='row-span-1 relative'>
          <Image src={'/img/about-1.jpg'} width={0} height={0} sizes='100' alt='' className='rounded-xl w-full' />
        </div>
      </div>
